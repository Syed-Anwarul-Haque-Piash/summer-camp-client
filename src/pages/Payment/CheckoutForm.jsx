...
const CheckoutForm = ({ price, data }) => {
  ...
  const { data: paymentData = [], refetch } = useQuery(["users"], async () => {
    const res = await axios.post("https://summer-camp-server-flame-three.vercel.app/create-payment-intent", { price });
  ...
  const handleSubmit = async (event) => {
    ...
    if (paymentIntent.status === "succeeded") {
      ...
      axios.post("https://summer-camp-server-flame-three.vercel.app/payments", payment).then((res) => {
        if (res.data) {
